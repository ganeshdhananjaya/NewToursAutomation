package com.automation.NewTours.testdata;
...
import com.automation.NewTours.Apps.DriverApp;
	...
	public static void startTesting(String filename,String testStartTime,String env,String rel)
	  {
	    ...
	    out.write("<html>\n");
	    out.write("<HEAD>\n");
	    out.write(" <TITLE> NewTours Automation Test Results by QA Team</TITLE>\n");
	     out.write("</HEAD>\n");
			...
			// out.newLine();
		     ...
		     if(status.equalsIgnoreCase("Skipped") || status.equalsIgnoreCase("Skip"))
		    	 ...
		    	 out.write("<td width=40% align= center ><FONT COLOR=black FACE= Arial  SIZE=2><b><a href=file:///"+currentDir+"//"+currentSuiteName+"_TC"+tcid+"_"+testCaseName.replaceAll(" ", "_")+DriverApp.year+"_"+DriverApp.date+"_"+(DriverApp.month+1)+"_"+DriverApp.day+"_"+DriverApp.min+"_" +DriverApp.sec+".html>"+testCaseName+"</a></b></td>\n");
		    	                                                                                                     // fstream = new FileWriter(currentDir+"//"+currentSuiteName+"_TC"+tcid+"_"+testCaseName.replaceAll(" ", "_")+DriverApp.year+"_"+DriverApp.date+"_"+(DriverApp.month+1)+"_"+DriverApp.day+"_"+DriverApp.min+"_" +DriverApp.sec+".html");
		        // out.write("<td width=40% align= center ><FONT COLOR=black FACE= Arial  SIZE=2><b><a href=  " + currentDir+ "//" + currentSuiteName+"_TC"+tcid+"_"+testCaseName.replaceAll(" ", "_")+DriverApp.year+"_"+DriverApp.date+"_"+(DriverApp.month+1)+"_"+DriverApp.day+"_"+DriverApp.min+"_" +DriverApp.sec+".html>"+testCaseName+"</a></b></td>\n");
